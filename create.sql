...
CREATE TABLE Orders(
	...
	FOREIGN KEY(Delievery_partner_ID) REFERENCES Delievery_Guy(Delievery_partner_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Have_offer(
	...
	FOREIGN KEY(RestaurantID) REFERENCES Restaurant(RestaurantID) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY(OfferID) REFERENCES Offer(OfferID) ON DELETE CASCADE ON UPDATE CASCADE
);